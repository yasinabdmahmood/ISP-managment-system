Rails.application.config.middleware.insert_before 0, Rack::Cors do
    allow do
      origins 'https://isp.yyaassiinn.xyz', 'https://isp-react.netlify.app', 'http://localhost:3001', 'https://isp-system-react.onrender.com', 'https://baban-net-frontend.herokuapp.com'
