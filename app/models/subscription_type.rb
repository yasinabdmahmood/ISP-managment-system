class SubscriptionType < ApplicationRecord
    ...
    private
        ...
        def save_new_record_to_activity
            create_activity_record(action_type: 'create' ,table_name: 'subscription type' ,json_data: self)
            # Activity.create(
        ...
        def save_deleted_record_to_activity
            create_activity_record(action_type: 'delete' ,table_name: 'subscription type' ,json_data: self)
            # Activity.create(
            #     employee_name: Current.employee.name,
            #     action_type: 'delete',
            #     table_name: 'client',
