...
task test2: :environment do
    ...
    daily_reports.each do |daily_report|
        daily_report_payment = daily_report['data']['report']['profit_statistics']['sum_of_total_profit']
    ...
    p '+++++++++++++++++++++++++++++++++++++'
    p "monthly report payment ===> #{monthly_report['data']['report']['profit_statistics']['sum_of_total_profit']}"
    p '+++++++++++++++++++++++++++++++++++++'
